...
from src.config import MITO_COMPETITION_RAT_TRAIN_STACKS,\
    MITO_COMPETITION_RAT_VALIDATION_STACKS, PATCH_SHAPE, MITO_LEARNING_RATE
...
def main():
    ...
    train_model(model=model,
                model_name='mito_8nm_rat_boundary',
                loss_func=dice_loss,
                optimizer=optimizer,
