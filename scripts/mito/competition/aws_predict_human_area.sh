...
docker run --gpus all --entrypoint python3 -v "$projectdir/data:/em/data" pytorch-organelle-ml -u scripts/mito/competition/predict_human_area.py "$image_stacks_path" "$label_stacks_path" $save_folder
